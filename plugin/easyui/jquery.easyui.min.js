...
(function($){
    ...
    var _790={render:function(_791,_792,_793){
        ...
        var _999width = opts.minWidth ? opts.minWidth : 100;
        var _79e=["<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" style=\"min-width:"+ _999width +"px\"><tbody>"];
        for(var i=0;i<rows.length;i++){
            var row=rows[i];
